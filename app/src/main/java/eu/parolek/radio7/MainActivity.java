...
import eu.parolek.radio7.helpers.ShoutcastParser;
import eu.parolek.radio7.helpers.ModifiedWebView;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private String chosenChannel = "Radio 7 128 kbps MP3";
    ...
    private void setupShoutcastAddresses() {
        channelSCAddressHash.put("Radio 7 128 kbps MP3", "http://icecast8.play.cz/radio7-128.mp3");
    ...
    private void startGreetingsWebView() {
        ...
        if (chosenChannel.equals("Radio 7 128 kbps MP3")) {
            wv.loadUrl("http://m.twr.cz/android/vysilame_utf8.php");
        }
    ...
    private void startScheduleWebView() {
        ...
        } else if (chosenChannel.equals("Radio 7 128 kbps MP3")) {
